...
// length: 문자열의 길이
let str = "ABCDE";
let str1 = "안녕하세요 저는 둘리입니다";


let result = str1.indexOf("둘리")

console.log(result);
console.log(str.indexOf("또치"));
